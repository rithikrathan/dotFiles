...
M.config = {
	...
	colors = {
		...
		search_highlight     = "#080810",
		search_bg            = "#b8c8d0",
		inc_search_bg        = "#7898b0",
		inc_search_fg        = "#080810",
		cur_search_bg        = "#a0b0c0",
		glow_color           = "#e0e0e8",
...
function M.setup(user_config)
	...
	local highlight_groups = {
		...
		ModeNorm                    = { fg = colors.bg, bg = colors.blue1, italic = true, bold = true },
		SepNormA                    = { fg = colors.blue1, bg = colors.pmenu_bg },
		...
		ModeVis                     = { fg = colors.bg, bg = colors.purple1, italic = true, bold = true },
		SepVisA                     = { fg = colors.purple1, bg = colors.pmenu_bg },
		...
		["@parameter"]              = { fg = colors.purple1, italic = true },
		["@parameter.reference"]    = { fg = colors.purple1 },
		["@field"]                  = { fg = colors.fg },
		...
		TelescopeSelectionCaret     = { fg = colors.blue1, bg = colors.visual },
		...
		FlashLabel                  = { bg = colors.purple2, fg = colors.black, bold = true },
