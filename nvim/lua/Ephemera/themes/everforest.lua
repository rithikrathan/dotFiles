...
M.config = {
	...
	colors = {
		...
		search_highlight     = "#060608",
		search_bg            = "#d0c080",
		inc_search_bg        = "#8fbd8f",
		inc_search_fg        = "#060608",
		cur_search_bg        = "#bda860",
		glow_color           = "#f0f4f0",
...
function M.setup(user_config)
	...
	local highlight_groups = {
		...
		ModeNorm                    = { fg = colors.bg, bg = colors.green1, italic = true, bold = true },
		SepNormA                    = { fg = colors.green1, bg = colors.pmenu_bg },
