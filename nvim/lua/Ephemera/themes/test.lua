...
M.config = {
	...
	colors = {
		-- Base UI (Deep Dark Navy)
		fg                   = "#E5E7EB", -- Clean, crisp white for high contrast
		bg                   = "#0A0F1D", -- Deep dark midnight blue background
		bgl                  = "#10172A", -- Slightly lighter navy for statuslines
		black                = "#05080F", -- True dark
		white                = "#FFFFFF",
		eob                  = "#1E293B", -- Subtle end-of-buffer markers
		border               = "#334155", -- Clean, slate-blue borders
		title                = "#38BDF8", -- Bright Sky Blue

		-- Cursor & Selection
		cursor               = "#FF2A54", -- Crimson red cursor
		cursorLine           = "#131C33", -- Subtle highlight over the navy
		visual               = "#1E3A5F", -- Distinct deep-sea blue selection
		line_nr              = "#475569", -- Muted slate for line numbers

		-- Syntax (Custom Red/Blue Palette)
		comment              = "#64748B", -- Slate gray for comments
		string               = "#FCA5A5", -- Soft coral/light red for strings
		func                 = "#38BDF8", -- Bright Sky Blue for functions
		kw                   = "#FF2A54", -- Crimson Neon Red for keywords
		identifier           = "#E5E7EB", -- Crisp white (Keeps normal text highly readable)
		type                 = "#818CF8", -- Indigo/Soft blue for types
		type_builtin         = "#FF7185", -- Rose/Red for builtin types
		operator             = "#00E5FF", -- Electric Cyan
		bracket              = "#94A3B8", -- Lighter slate for brackets
		preprocessor         = "#FB7185", -- Rose
		bool                 = "#FF2A54", -- Crimson
		constant             = "#FF7185", -- Rose

		-- Search & Highlighting
		search_highlight     = "#FFFFFF",
		search_bg            = "#FF2A54", -- Red search background
		inc_search_bg        = "#38BDF8", -- Blue background for active search
		inc_search_fg        = "#05080F",
		cur_search_bg        = "#FF2A54",
		glow_color           = "#E5E7EB",

		-- Popup Menu (High Contrast Floating Windows)
		pmenu_bg             = "#1E293B", -- Elevated slate-blue for floats
		pmenu_sel_bg         = "#1E3A5F", -- Deep sea blue selection
		pmenu_fg             = "#E5E7EB",

		-- Git
		added                = "#38BDF8", -- Blue for added (customizing to theme)
		changed              = "#818CF8", -- Indigo
		removed              = "#FF2A54", -- Crimson Red

		-- Diagnostics
		error                = "#FF2A54", -- Crimson Red
		warning              = "#FBBF24", -- Amber (kept yellow for universal warning logic)
		hint                 = "#00E5FF", -- Electric Cyan
		info                 = "#38BDF8", -- Sky Blue

		-- Plugin Specific
		bufferline_selection = "#38BDF8",
		cyan                 = "#00E5FF",
		purple_light         = "#818CF8",
		quote_fg             = "#475569",
		...
		red3                 = "#BE123C",
		red4                 = "#FF2A54",
		red_light            = "#FF2A54", -- Crimson welcome rose

		green1               = "#10B981", -- Kept a true green in reserve just in case
		green2               = "#34D399",
		green3               = "#059669",
		green4               = "#10B981",
...
function M.setup(user_config)
	...
	local highlight_groups = {
		...
		ModeIns                     = { fg = colors.bg, bg = colors.red1, italic = true, bold = true },
		SepInsA                     = { fg = colors.red1, bg = colors.pmenu_bg },
		...
		TelescopeMatching           = { fg = colors.func, bg = "NONE", bold = true },
		...
		WelcomeStem                 = { fg = colors.blue1, bold = true },
		WelcomeQuote                = { fg = colors.quote_fg, italic = true },

		-- =====================================
		-- AERIAL
		-- =====================================
		AerialLine                  = { fg = colors.kw, bg = colors.visual, bold = true },
