...
M.config = {
	...
	colors = {
		...
		search_bg            = "#d0b050",
		inc_search_bg        = "#a8b860",
		inc_search_fg        = "#080808",
		cur_search_bg        = "#c0a040",
		glow_color           = "#f0e8d8",
...
function M.setup(user_config)
	...
	local highlight_groups = {
		...
		ModeNorm                    = { fg = colors.bg, bg = colors.orange1, italic = true, bold = true },
		SepNormA                    = { fg = colors.orange1, bg = colors.pmenu_bg },
	...
	for _, kind in ipairs(kinds) do highlight_groups["CmpItemKind" .. kind] = { fg = colors.orange1 } end
