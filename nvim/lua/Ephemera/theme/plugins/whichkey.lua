...
M.setup = function()
	local colors = require("Ephemera.theme.colors").config.colors
	local enabled = require("Ephemera.theme.colors").config.colors.plugins.whichkey
	local transparent = require("Ephemera.theme.colors").config.transparent
